    ...
    void insert_fixup(node_ptr& new_node)
    {
        ...
        while(parent_node->is_red())
        {
            ...
            else
            {
                ...
                {
                    ensure_new_node_is_left_child(new_node, parent_node);
                    make_parent_node_black(parent_node, rotateRight);
                }
                else
                {
                    ensure_new_node_is_right_child(new_node, parent_node);
                    make_parent_node_black(parent_node, rotateLeft);
                }
            }
